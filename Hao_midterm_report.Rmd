...
## Model Comparison
To decide which model fits better, I conduct a resample comparison on the training data. From the box plot, we can see GLM and MARS model have rather high values of ROC. We then make predictions on the test data and plot the ROC curves for each model. 

## Conclusion
In conclusion, the mobile dataset is a rather\
